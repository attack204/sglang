...
class Siglip2EncoderLayer(nn.Module):
    def __init__(self, config: Siglip2Config, head_num):
        super().__init__()
        self.embed_dim = config.hidden_size
        # sdpa attention
        self.attn = VisionAttention(
            ...
            # TODO: use_context_forward = use_context_forward
...
class Siglip2Encoder(nn.Module):
    ...
    def __init__(self, config: Siglip2Config, head_num):
        ...
        self.layers = nn.ModuleList([Siglip2EncoderLayer(config, head_num) for _ in range(config.num_hidden_layers)])
...
class Siglip2VisionTransformer(nn.Module):
    def __init__(self, config: Siglip2VisionConfig):
        ...
        self.encoder = Siglip2Encoder(config, self.head_num)
