...
#
#
# class Siglip2ConfigSg(PretrainedConfig):
#     r"""
...
# #
# # AutoImageProcessor.register(Siglip2ConfigSg, None, Siglip2VisionConfig, None)
# # AutoProcessor.register(Siglip2ConfigSg, Siglip2Model)
